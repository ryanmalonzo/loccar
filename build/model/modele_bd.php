...
function getModele($idModele, &$modele = array()) {
    ...
    $sql = "SELECT * FROM model WHERE idModele = :idModele";
...
function getTarifJournalier($idModele) {
    ...
    $sql = "SELECT tarifJournalier FROM model WHERE idModele = :idModele";
...
function insererModele($nomModele, $caracteristiques, $photo, $tarifJournalier) {
    ...
    $sql = "INSERT INTO model VALUES (DEFAULT, :nomModele, :caracteristiques, :photo, :tarifJournalier)";
