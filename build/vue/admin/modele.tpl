...
<section class="contact-clean">
    <form method="post" action="index.php?controle=admin&action=modele" enctype="multipart/form-data">
        ...
        <?php echo $message ?>
        <div class="mb-2"><label class="form-label" for="nomModele">Nom du modèle</label><input class="form-control" type="text" required name="nomModele" placeholder="Nissan Qashqai"></div>
        ...
        <div class="container" style="padding: 0;">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-2"><label class="form-label" for="nbPlaces">Nombre de places</label><input class="form-control" type="number" name="nbPlaces" min="1" max="8" placeholder="5"></div>
                </div>
            </div>
        </div>
        <div class="container" style="padding: 0;">
        ...
        <div class="mb-2"><button class="btn btn-primary" type="submit" style="width: 100%;">AJOUTER</button></div>
    </form>
</section>
