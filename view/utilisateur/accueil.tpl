    ...
    <div class="container hero">
        <div class="row">
            <div class="col-12 col-lg-6 col-xl-5 offset-xl-1 align-self-center">
                ...
                <p>Louer une voiture n'a jamais été aussi simple.</p><a class="btn btn-light btn-lg action-button"
                                                                        type="button" role="button"
                                                                        href="index.php?controle=voiture&action=liste">Réserver
                    une voiture</a>
            </div>
            <div class="col-md-5 col-lg-5 offset-lg-1 offset-xl-0 d-none d-lg-none d-xl-flex align-items-xl-center phone-holder">
                <img class="img-fluid d-xl-flex align-items-xl-center"
                     src="assets/img/sunset-car-vehicle-road-evening-morning-Audi-side-view-dusk-r8-v10-automobile-make-559259.png"
    ...
    <div class="container">
        ...
        <div class="row justify-content-center features">
            ...
            <div class="col-sm-auto col-md-6 col-lg-4 item">
                <div class="box"><img class="img-fluid" src="assets/img/Fabia.jpg" alt="Skoda Fabia"
                                      style="height: 200px;">
            ...
            <div class="col-sm-auto col-md-6 col-lg-4 item">
                <div class="box"><img class="img-fluid" src="assets/img/ClioIV.jpg" alt="Renault Clio IV"
                                      style="height: 200px;">
