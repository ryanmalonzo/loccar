...
<section class="register-photo">
    ...
    ', $erreur);
            ...
            <div class="mb-3"><input class="form-control" type="password" name="motdepasse" placeholder="Mot de passe"
                                     required>
            </div>
            <div class="mb-3">
                <select class="form-select" required name="societe">
                    ...
                    foreach ($entreprises as $entreprise) {
                        printf('<option value="%d">%s</option>', $entreprise["idEntreprise"],
            ...
            <div class="mb-3">
                <div class="form-check"><label class="form-check-label"><input class="form-check-input" type="checkbox"
                                                                               required>J'accepte les&nbsp;<a href="#">conditions
